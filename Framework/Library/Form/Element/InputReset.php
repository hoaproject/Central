 ...
 * @category    Framework
 * @package     Hoa_Form
 * @subpackage  Hoa_Form_Element_InputReset
 *
 */
...
/**
 * Class Hoa_Form_Element_InputReset.
 *
 * Describe the input type radio element.
 *
...
class Hoa_Form_Element_InputReset extends Hoa_Form_Element_Abstract {
    ...
    /**
     * Cannot set filter to a reset button, so throw an exception.
     *
     * @access  public
    ...
    public function setFilter ( $filters ) {
        ...
        throw new Hoa_Form_Exception('A reset button cannot have filters.', 0);
    }

    /**
     * Cannot set validator to a reset button, so throw an exception.
     *
     * @access  public
    ...
    public function setValidator ( $validators ) {
        ...
        throw new Hoa_Form_Exception('A reset button cannot have validators.', 1);
    }
    ...
    /**
     * Set value of the reset element. If the value is empty (not null, but
