 ...
 * @category    Framework
 * @package     Hoa_Form
 * @subpackage  Hoa_Form_Element_Legend
 *
 */
...
/**
 * Class Hoa_Form_Element_Legend.
 *
 * Describe the legend element.
 *
...
class Hoa_Form_Element_Legend extends Hoa_Form_Element_Abstract {
     ...
     * Value of the label.
     *
     * @var Hoa_Form_Element_Legend string
     */
    ...
    public function __toString ( ) {
        ...
        try {
            ...
            return '<legend' . $this->getAttributesChain() . '>' .
                   $this->getValue() .
                   '</legend>';
        }
