...
class Hoa_Tokenizer_Token_OutterPhp implements Hoa_Tokenizer_Token_Util_Interface {
     ...
     *
     * @access  public
     * @param   string  $data    Data that surrounds PHP source code.
     * @return  void
     */
    ...
    /**
     * Set data that surround PHP source code.
     *
     * @access  public
